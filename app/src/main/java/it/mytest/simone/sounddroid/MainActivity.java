package it.mytest.simone.sounddroid;
...
import it.mytest.simone.sounddroid.it.mytest.simone.sounddroid.soundcloud.SoundCloud;
import it.mytest.simone.sounddroid.it.mytest.simone.sounddroid.soundcloud.SoundCloudService;
import it.mytest.simone.sounddroid.it.mytest.simone.sounddroid.soundcloud.Track;
...
public class MainActivity extends ActionBarActivity implements SearchView.OnQueryTextListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        service.getMostRecentSong(new SimpleDateFormat("yyyy-MM-dd hh:mm:ss").format(new Date()),new Callback<List<Track>>() {
            @Override
            public void success(List<Track> tracks, Response response) {
                updateTracks(tracks);
            }
